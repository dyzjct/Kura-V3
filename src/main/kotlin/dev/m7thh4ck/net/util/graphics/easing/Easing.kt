...
package dev.m7thh4ck.net.util.graphics.easing

import dev.m7thh4ck.net.util.extension.cubic
import dev.m7thh4ck.net.util.extension.quart
import dev.m7thh4ck.net.util.extension.quint
import dev.m7thh4ck.net.util.extension.sq
import dev.m7thh4ck.net.util.math.MathUtils
import dev.m7thh4ck.net.util.math.PI_FLOAT
...
enum class Easing {
    ...
    fun inc(x: Float, max: Float): Float =
        if (max == 0.0f) 0.0f else if (x <= 0.0f) 0.0f else if (x >= 1.0f) max else inc0(x) * max
