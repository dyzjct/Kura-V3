...
import dev.m7thh4ck.net.mod.module.impl.player.PacketMine.relative
import dev.m7thh4ck.net.mod.module.impl.player.PacketMine.swing
...
import dev.m7thh4ck.net.util.entity.EntityUtil.noCollision
import dev.m7thh4ck.net.util.extension.fastCeil
import dev.m7thh4ck.net.util.extension.sq
import dev.m7thh4ck.net.util.item.isTool
import dev.m7thh4ck.net.util.math.vector.Vec3f
import dev.m7thh4ck.net.util.math.vector.VectorUtils.toBlockPos
import dev.m7thh4ck.net.util.math.vector.VectorUtils.toVec3dCenter
import dev.m7thh4ck.net.util.other.EnumSet
