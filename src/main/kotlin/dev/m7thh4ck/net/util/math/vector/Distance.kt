...
package dev.m7thh4ck.net.util.math.vector
...
inline fun Entity.distanceTo(chunkPos: ChunkPos): Double {
    return distance(this.pos.x, this.pos.z, (chunkPos.x * 16 + 8).toDouble(), (chunkPos.z * 16 + 8).toDouble())
}

inline fun Entity.distanceSqToBlock(chunkPos: ChunkPos): Int {
    return distanceSq(this.pos.x.fastFloor(), this.pos.z.fastFloor(), chunkPos.x * 16 + 8, chunkPos.z * 16 + 8)
}
...
inline fun Entity.distanceTo(vec3d: Vec3d): Double {
    return distance(this.pos.x, this.pos.y, this.pos.z, vec3d.x, vec3d.y, vec3d.z)
}

inline fun Entity.distanceTo(vec3i: Vec3i): Double {
    return distance(this.pos.x, this.pos.y, this.pos.z, vec3i.x + 0.5, vec3i.y + 0.5, vec3i.z + 0.5)
}

inline fun Entity.distanceTo(x: Double, y: Double, z: Double): Double {
    return distance(this.pos.x, this.pos.y, this.pos.z, x, y, z)
}

inline fun Entity.distanceTo(x: Int, y: Int, z: Int): Double {
    return distance(this.pos.x, this.pos.y, this.pos.z, x + 0.5, y + 0.5, z + 0.5)
}

inline fun Entity.distanceSqTo(player: PlayerEntity): Double {
    return distanceSq(this.pos.x, this.pos.y, this.pos.z, player.pos.x, player.pos.y, player.pos.z)
}

inline fun Entity.distanceSqTo(vec3d: Vec3d): Double {
    return distanceSq(this.pos.x, this.pos.y, this.pos.z, vec3d.x, vec3d.y, vec3d.z)
}

inline fun Entity.distanceSqTo(vec3i: Vec3i): Double {
    return distanceSq(this.pos.x, this.pos.y, this.pos.z, vec3i.x + 0.5, vec3i.y + 0.5, vec3i.z + 0.5)
}

inline fun Entity.distanceSqTo(x: Double, y: Double, z: Double): Double {
    return distanceSq(this.pos.x, this.pos.y, this.pos.z, x, y, z)
}

inline fun Entity.distanceSqTo(x: Int, y: Int, z: Int): Double {
    return distanceSq(this.pos.x, this.pos.y, this.pos.z, x + 0.5, y + 0.5, z + 0.5)
}
